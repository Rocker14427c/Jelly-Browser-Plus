...
class SharedPreferencesExt(context: Context) {
    ...
    val adBlockEnabled: Boolean
        get() = sharedPreferences.getBoolean(ADBLOCK_KEY, ADBLOCK_DEFAULT)
    ...
    companion object {
        ...
        private const val ADBLOCK_KEY = "key_adblock"
        private const val ADBLOCK_DEFAULT = true
        private const val ADBLOCK_LEVEL_KEY = "key_adblock_level"
